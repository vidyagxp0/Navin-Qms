                    ...
                    <div class="head">
                     ...
                     <table>
                                ...
                                <tr>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if($data4->Production_Review){{ $data4->Production_Review }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                    <th class="w-20">Production Person</th>
                                    <td class="w-30">
                                        <div>
                                            @if($data4->Production_person){{ $data4->Production_person }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if($data4->Production_assessment){{ $data4->Production_assessment }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                    <th class="w-20">Production Feedback</th>
                                    <td class="w-30">
                                        <div>
                                            @if($data4->Production_feedback){{ $data4->Production_feedback }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if($data4->Production_Review_Completed_By){{ $data4->production_by }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                    <th class="w-20">Production Review Completed On</th>
                                    <td class="w-30">
                                        <div>
                                            @if($data4->production_on){{ $data4->production_on }}@else Not Applicable @endif
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="border-table">
                ...
                <table>
                    ...
                    <tr class="table_bg">
                        ...
                        @if($data4->production_attachment)
                        @foreach(json_decode($data4->production_attachment) as $key => $file)
                            <tr>
                                <td class="w-20">{{ $key + 1 }}</td>
                                <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                            </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_review){{ $data4->Warehouse_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Warehouse Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_notification){{ $data4->Warehouse_notification }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_assessment){{ $data4->Warehouse_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Warehouse Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_feedback){{ $data4->Warehouse_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_by){{ $data4->Warehouse_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Warehouse Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Warehouse_Review_Completed_On){{ $data4->Warehouse_Review_Completed_On }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Warehouse_attachment)
                            @foreach(json_decode($data4->Warehouse_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_review){{ $data4->Quality_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Control Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Control_Person){{ $data4->Quality_Control_Person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Control_assessment){{ $data4->Quality_Control_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Control Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Control_feedback){{ $data4->Quality_Control_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->QualityAssurance__by){{ $data4->QualityAssurance__by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Control_on){{ $data4->Quality_Control_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Quality_Control_attachment)
                            @foreach(json_decode($data4->Quality_Control_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Assurance){{ $data4->Quality_Assurance }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Assurance Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->QualityAssurance_person){{ $data4->QualityAssurance_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->QualityAssurance_assessment){{ $data4->QualityAssurance_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Assurance feedback Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Quality_Assurance_feedback){{ $data4->Quality_Assurance_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->QualityAssurance_by){{ $data4->QualityAssurance_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Quality Assurance Review Completed  On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->QualityAssurance_on){{ $data4->QualityAssurance_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Quality_Assurance_attachment)
                            @foreach(json_decode($data4->Quality_Assurance_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_review){{ $data4->Engineering_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Engineering Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_person){{ $data4->Engineering_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_assessment){{ $data4->Engineering_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Engineering Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_feedback){{ $data4->Engineering_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_by){{ $data4->Engineering_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Engineering Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Engineering_on){{ $data4->Engineering_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Engineering_attachment)
                            @foreach(json_decode($data4->Engineering_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_review){{ $data4->Analytical_Development_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Analytical Development Laboratory Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_person){{ $data4->Analytical_Development_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_assessment){{ $data4->Analytical_Development_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Analytical Development Laboratory  Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_feedback){{ $data4->Analytical_Development_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_by){{ $data4->Analytical_Development_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Analytical Development Laboratory Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Analytical_Development_on){{ $data4->Analytical_Development_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Analytical_Development_attachment)
                            @foreach(json_decode($data4->Analytical_Development_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_review){{ $data4->Kilo_Lab_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Process Development Laboratory / Kilo Lab Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_person){{ $data4->Kilo_Lab_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_assessment){{ $data4->Kilo_Lab_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Process Development Laboratory / Kilo Lab  Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_feedback){{ $data4->Kilo_Lab_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_attachment_by){{ $data4->Kilo_Lab_attachment_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Process Development Laboratory / Kilo Lab Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Kilo_Lab_attachment_on){{ $data4->Kilo_Lab_attachment_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Kilo_Lab_attachment)
                            @foreach(json_decode($data4->Kilo_Lab_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_review){{ $data4->Technology_transfer_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Technology Transfer / Design Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_person){{ $data4->Technology_transfer_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_assessment){{ $data4->Technology_transfer_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Technology Transfer / Design Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_feedback){{ $data4->Technology_transfer_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_by){{ $data4->Technology_transfer_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Technology Transfer / Design Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Technology_transfer_on){{ $data4->Technology_transfer_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Technology_transfer_attachment)
                            @foreach(json_decode($data4->Technology_transfer_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Environment_Health_review){{ $data4->Environment_Health_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Environment, Health & Safety Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Environment_Health_Safety_person){{ $data4->Environment_Health_Safety_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Health_Safety_assessment){{ $data4->Health_Safety_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Environment, Health & Safety Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Health_Safety_feedback){{ $data4->Health_Safety_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->production_by){{ $data4->Human_Resource_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Environment, Health & Safety Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_on){{ $data4->Human_Resource_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Human_Resource_attachment)
                            @foreach(json_decode($data4->Human_Resource_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_review){{ $data4->Human_Resource_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Human Resource & Administration Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_person){{ $data4->Human_Resource_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_assessment){{ $data4->Human_Resource_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Human Resource & Administration Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_feedback){{ $data4->Human_Resource_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Human_Resource_by){{ $data4->production_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Initial_attachment)
                            @foreach(json_decode($data4->Initial_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_review){{ $data4->Information_Technology_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Information Technology Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_person){{ $data4->Information_Technology_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_assessment){{ $data4->Information_Technology_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Information Technology Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_feedback){{ $data4->Information_Technology_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_by){{ $data4->Information_Technology_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Information Technology Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Information_Technology_on){{ $data4->Information_Technology_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Information_Technology_attachment)
                            @foreach(json_decode($data4->Information_Technology_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_review){{ $data4->Project_management_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Project Management Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_person){{ $data4->Project_management_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_assessment){{ $data4->Project_management_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Project Management Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_feedback){{ $data4->Project_management_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_by){{ $data4->Project_management_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Project Management Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Project_management_on){{ $data4->Project_management_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Project_management_attachment)
                            @foreach(json_decode($data4->Project_management_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_review){{ $data4->Other1_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 1 Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_person){{ $data4->Other1_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 1 Department</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_Department_person){{ $data4->Other1_Department_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_assessment){{ $data4->Other1_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 1 Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_feedback){{ $data4->Other1_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_by){{ $data4->Other1_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Other's 1 Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other1_on){{ $data4->Other1_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Other1_attachment)
                            @foreach(json_decode($data4->Other1_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_review){{ $data4->Other2_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 2 Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_person){{ $data4->Other2_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 2 Department</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_Department_person){{ $data4->Other2_Department_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_assessment){{ $data4->Other2_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 2 Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_feedback){{ $data4->Other2_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_by){{ $data4->Other2_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Other's 2 Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other2_on){{ $data4->Other2_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Other2_attachment)
                            @foreach(json_decode($data4->Other2_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_review){{ $data4->Other3_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 3 Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_person){{ $data4->Other3_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 3 Department</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_Department_person){{ $data4->Other3_Department_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_assessment){{ $data4->Other3_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 3 Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_feedback){{ $data4->Other3_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_by){{ $data4->Other3_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Other's 3 Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other3_on){{ $data4->Other3_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Other3_attachment)
                            @foreach(json_decode($data4->Other3_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_review){{ $data4->Other4_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 4 Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_person){{ $data4->Other4_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 4 Department</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_Department_person){{ $data4->Other4_Department_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_assessment){{ $data4->Other4_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 4 Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_feedback){{ $data4->Other4_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_by){{ $data4->Other4_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Other's 4 Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other4_on){{ $data4->Other4_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Other4_attachment)
                            @foreach(json_decode($data4->Other4_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
                ...
                <div class="head">
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_review){{ $data4->Other5_review }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 5 Person</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_person){{ $data4->Other5_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 5 Department</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_Department_person){{ $data4->Other5_Department_person }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_assessment){{ $data4->Other5_assessment }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20">Other's 5 Feedback</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_feedback){{ $data4->Other5_feedback }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_by){{ $data4->Other5_by }}@else Not Applicable @endif
                                    </div>
                                </td>
                                <th class="w-20"> Other's 5 Review Completed On</th>
                                <td class="w-30">
                                    <div>
                                        @if($data4->Other5_on){{ $data4->Other5_on }}@else Not Applicable @endif
                                    </div>
                                </td>
                            </tr>
                    </table>
                  ...
                  <div class="border-table">
                    ...
                    <table>
                        ...
                        <tr class="table_bg">
                            ...
                            @if($data4->Other5_attachment)
                            @foreach(json_decode($data4->Other5_attachment) as $key => $file)
                                <tr>
                                    <td class="w-20">{{ $key + 1 }}</td>
                                    <td class="w-20"><a href="{{ asset('upload/' . $file) }}" target="_blank"><b>{{ $file }}</b></a> </td>
                                </tr>
