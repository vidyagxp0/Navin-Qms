        ...
        <div id="CCForm9" class="inner-block cctabcontent">
            <div class="inner-block-content">
                <div class="row">
                    ...
                    @if($data->Investigation_required == 'yes'){
                        @if ($data->investigation_attachment_need)
                            @foreach (json_decode($data->investigation_attachment_need) as $file)
                                <input id="InvestigationFile-{{ $loop->index  }}" type="hidden" name="existing_investigation_attachment_need[{{ $loop->index  }}]" value="{{ $file }}">
                            @endforeach
                        @endif
                        <div class="col-lg-12">
                            <div class="group-input">
                                                ...
                                                <h6 class="file-container text-dark"
                                                    ...
                                                    <a href="{{ asset('upload/' . $file) }}"
                                                        target="_blank"><i class="fa fa-eye text-primary"
                                                            style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a class="remove-file"
                                                    data-remove-id="InvestigationFile-{{ $loop->index }}"
                                                        data-file-name="{{ $file }}"><i
                                                            class="fa-solid fa-circle-xmark"
                                                            style="color:red; font-size:20px;"></i></a>
                                                </h6>
                    ...
                    <div class="col-lg-6 mt-2">
                        <div class="group-input">
                            ...
                            <select name="Customer_notification" id="Customer_notification" >
                                <option value="0">-- Select --</option>
                                <option 
                                value="Yes" @if ($data->Customer_notification == 'Yes') selected @endif>Yes</option>
                                <option  
                                value="No" @if ($data->Customer_notification == 'No') selected @endif>No</option>
                                <option  
                                    value="NA" @if ($data->Customer_notification == 'NA') selected @endif>NA</option>
                            </select>
                            @error('Customer_notification')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
