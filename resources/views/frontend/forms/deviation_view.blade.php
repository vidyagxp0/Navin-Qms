                                ...
                                <div class="col-md-12 mb-3">
                                 ...
                                 <div class="col-lg-6 new-date-data-field">
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            <input type="text" id="Capa_reported_date"  placeholder="DD-MMM-YYYY" />
                                            <input type="date"  name="capa_completed_date" max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                             class="hide-input" oninput="handleDateInput(this, 'Capa_reported_date')" required />
                                        </div>
                                    </div>
                                </div>
