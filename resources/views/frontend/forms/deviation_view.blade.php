                ...
                <form id="auditForm" action="{{ route('deviationupdate', $data->id) }}" method="post"
                    ...
                    <div id="step-form">
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                $('#Initial_Deviation_category, #Investigation_required, #qrm_required, #capa_required').change(
                                    function() {
                                        // Get the selected values
                            ...
                            <div class="inner-block-content">
                                @if ($data->stage == 3)
                                    <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="group-input">
                                                    ...
                                                    <div><small class="text-primary">Please insert "NA" in the data field
                                                            if it does not require completion</small></div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="group-input" id="investigation_details_block"
                                                style="display: none">
                                ...
                                <div class="button-block">
                                    <button type="submit"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                        id="ChangesaveButton03" class="saveAuditFormBtn d-flex"
                                        style="align-items: center;">
                                        <div class="spinner-border spinner-border-sm auditFormSpinner"
                                            style="display: none" role="status">
                                            <span class="sr-only">Loading...</span>
                            ...
                            <div class="inner-block-content">
                                <div class="row">
                                    ...
                                    @if ($data->stage == 3 || $data->stage == 4)
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="group-input">
                                                <label for="Warehouse Feedback">Warehouse Feedback <span
                                                        id="asteriskware3"
                                                        style="display: {{ $data1->Warehouse_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                        class="text-danger">*</span></label>
                                                <div><small class="text-primary">Please insert "NA" in the data field if
                                    ...
                                    @else
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select disabled name="Warehouse_notification"
                                                    id="Warehouse_notification"
                                                    value="{{ $data1->Warehouse_notification }}">
                                                    <option value=""> -- Select --</option>
                                                    @foreach ($users as $user)
                                        ...
                                        @if ($data->stage == 4)
                                            <div class="col-md-12 mb-3">
                                                <div class="group-input">
                                                    <label for="Impact Assessment1">Impact Assessment (By
                                                        Warehouse)</label>
                                                    <div><small class="text-primary">Please insert "NA" in the data field
                                                            if it does not require completion</small></div>
                            ...
                            @else
                                ...
                                @if ($data->stage == 3 || $data->stage == 4)
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select name="Engineering_person" class="Engineering_person"
                                                ...
                                                @foreach ($users as $user)
                                                    <option
                                                        {{ $data1->Engineering_person == $user->id ? 'selected' : '' }}
                                                        value="{{ $user->id }}">{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="group-input">
                                            <label for="Analytical Development Laboratory Feedback"> Analytical
                                                Development Laboratory Feedback <span id="asteriskAD2"
                                                    style="display: {{ $data1->Analytical_Development_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="group-input">
                                            ...
                                            <input disabled type="text"
                                                value="{{ $data1->Analytical_Development_by }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Process Development Laboratory"> Process Development Laboratory /
                                                Kilo Lab Review Required ? <span class="text-danger">*</span></label>
                                            <select @if ($data->stage == 3) required @endif
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Process Development Laboratory"> Process Development Laboratory /
                                                Kilo Lab Person <span id="asteriskPDL"
                                                    style="display: {{ $data1->Kilo_Lab_review == 'yes' ? 'inline' : 'none' }}"
                                                    class="text-danger">*</span></label>
                                            <select name="Kilo_Lab_person" class="Kilo_Lab_person"
                                                id="Kilo_Lab_person" @if ($data->stage == 4) disabled @endif>
                                                <option value="0">-- Select --</option>
                                                @foreach ($users as $user)
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="group-input">
                                            <label for="Kilo Lab Review Completed On">Process Development Laboratory /
                                                Kilo Lab Review Completed On</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="group-input">
                                            ...
                                            <input disabled type="text"
                                                value="{{ $data1->Technology_transfer_by }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Customer notification">Human Resource & Administration Review
                                                Required ? <span class="text-danger">*</span></label>
                                            <select @if ($data->stage == 3) required @endif
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Customer notification"> Human Resource & Administration Person
                                                <span id="asteriskHR"
                                            ...
                                            <select name="Human_Resource_person" class="Human_Resource_person"
                                                ...
                                                @foreach ($users as $user)
                                                    <option
                                                        {{ $data1->Human_Resource_person == $user->id ? 'selected' : '' }}
                                                        value="{{ $user->id }}">{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="group-input">
                                            <label for="Administration Review Completed By"> Human Resource &
                                                Administration Review Completed By</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="group-input">
                                            <label for="Administration Review Completed On"> Human Resource &
                                                Administration Review Completed On</label>
                                            <input type="date" id="Environment_Health_Safety_on"
                                                name="Environment_Health_Safety_on"
                                                value="{{ $data1->Environment_Health_Safety_on }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Information Technology Review Required"> Information Technology
                                                Review Required ? <span class="text-danger">*</span></label>
                                            <select @if ($data->stage == 3) required @endif
                                                name=" Information_Technology_review"
                                ...
                                @else
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Quality Assurance Review Required">Quality Assurance Review
                                                Required ?</label>
                                            <select disabled name="Quality_Assurance_Review"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select disabled name="QualityAssurance_person"
                                                id="QualityAssurance_person">
                                                <option value="">-- Select --</option>
                                                @foreach ($users as $user)
                                                    <option
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="group-input">
                                            <label for="Analytical Development Laboratory Feedback"> Analytical
                                                Development Laboratory Feedback</label>
                                            <textarea class="tiny"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Process Development Laboratory"> Process Development Laboratory /
                                                Kilo Lab Review Required ?</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Customer notification"> Human Resource & Administration
                                                Person</label>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <select name="Other1_Department_person"
                                                ...
                                                <option @if ($data1->Other1_Department_person == 'Process_Development_Lab') selected @endif
                                                    value="Process_Development_Lab">Process Development Laboratory / Kilo
                                                    Lab</option>
                    ...
                    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="investigation_Details_Details"
                                        ...
                                        <tbody>
                                            ...
                                            <td><input type="text" class="numberDetail" name="Responsibility[]">
                                            </td>
                                            <td><input type="text" class="Document_Remarks" name="Remarks[]"></td>
                        ...
                        <div class="col-lg-12">
                            <div class="group-input">
                                ...
                                <select multiple name="audit_type[]" id="audit_type">
                                    {{-- <option value="">Enter Your Selection Here</option> --}}
                                    <option value="1"
                                        {{ strpos($data->audit_type, 'Facility') !== false ? 'selected' : '' }}>Why-Why
                                        Chart</option>
                        ...
                        <div class="col-lg-12">
                            <div class="group-input" id="documentsRowname">
                                <label for="audit-agenda-grid">
                                    Root Cause
                                    <button type="button" name="audit-agenda-grid" id="root_cause_Details">+</button>
                                    <span class="text-primary" data-bs-toggle="modal"
                                        data-bs-target="#document-details-field-instruction-modal"
                                        style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                        (Launch Instruction)
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="Root_cause_Details_Details"
                                        ...
                                        <tbody>
                                            <td><input disabled type="text" name="serial[]" value="1"></td>
                                            <td> <select name="Root_Cause_Category[]" id="">
                                                    <option value="">-- Select --</option>
                                                    <option value="">name </option>
                                                </select></td>
                                            ...
                                            <td><input type="text" class="Document_Remarks" name="ifother[]"></td>
                                            <td><input type="text" class="Document_Remarks" name="Probability[]">
                                            </td>
                                            <td><input type="text" class="Document_Remarks" name="remarks[]"></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width: 150%"
                                        ...
                                        <tbody>
                                            ...
                                            <td><input type="text" class="Document_Remarks" name="Recorded_By[]">
                                            </td>
                                            <td><input type="text" class="Document_Remarks" name="Remarks[]"></td>
                                            <td><input type="text" class="Removebtn" name="Action[]"></td>
                                        </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 new-date-data-field">
                            <div class="group-input input-date">
                                ...
                                <div class="calenderauditee">
                                    <input type="text" id="Capa_reported_date" readonly
                        ...
                        <div class="col-md-12">
                            <div class="group-input">
                                ...
                                <select disabled
                                    ...
                                    <option @if ($data->Post_Categorization == 'critical') selected @endif value="critical">
                                        Critical</option>
                                </select>
                                {{-- @error('Post_Categorization')
                                          <div class="text-danger">{{ $message }}</div>
                ...
                <div class="inner-block-content">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    ...
                                    <div class="calenderauditee">
                                        <input type="text" id="Quality_Risk_Management_Extension_Completed_ON"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for=" Deviation_Effectiveness_Check_Plan_Proposed_By">Deviation Effectiveness
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="deviation_Effectiveness_Check_Closed_On">Deviation Effectiveness Check
                                        Closed On</label>
                                    <div class="calenderauditee">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for=" Investigation_Extension_Completed_By">CAPA Effectiveness Check Plan
                                        Proposed By </label>
                                    <select name="Investigation_Extension_Completed_By"
                                        id="Investigation_Extension_Completed_By">
                                        <option value="">-- Select --</option>
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="Investigation_Extension_Completed_On">CAPA Effectiveness Check Plan
                                        Proposed On</label>
                                    <div class="calenderauditee">
                                        <input type="text" id="Investigation_Extension_Completed_On" readonly
                                            placeholder="DD-MMM-YYYY" />
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for=" Investigation_Extension_Completed_By"> QRM Effectiveness Check Plan
                                        Proposed By </label>
                                    <select name="Investigation_Extension_Completed_By"
                                        id="Investigation_Extension_Completed_By">
                                        <option value="">-- Select --</option>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for=" Investigation_Extension_Completed_By">Investigation Effectiveness Check
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="Effectiveness_Check_Plan_Proposed_On">Investigation Effectiveness Check
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="Investigation_Effectiveness_Check_Closed_On">Investigation Effectiveness
            ...
            <div id="CCForm6" class="inner-block cctabcontent">
                <div class="inner-block-content">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="group-input"
                                style="width:1620px; height:100px; line-height:3em;  `padding:5px;">
                    ...
                    <div class="button-block">
                        ...
                        <button
                            type="submit"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}>Submit</button>
