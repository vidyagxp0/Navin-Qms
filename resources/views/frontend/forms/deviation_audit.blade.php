...
<body>
    ...
    <header>
       ...
       <div><strong>Originator :</strong>{{ Auth::user()->name }}</div>
       <div><strong>Short Description :</strong> {{$document->short_description}}</div>
       <div><strong>Due Date :</strong>  {{$document->due_date}}</div>
                ...
                <tr class="table_bg">
                 ...
                 <!-- ----------------------- -->
                        <td>
                         ...
                         <div style="margin-top: 5px;"><strong>Comments :</strong> {{$dataDemo->comment ? $dataDemo->comment  : "Not Applicable"}}</div>   <!--Record Is send by Hod Review--->

                        </td>
                        <!-- ------Record Is send by Hod Review----------- -->
                        <td>
                        <div>
                     <strong> Data Field Name :</strong>{{$dataDemo->activity_type ? $dataDemo->activity_type  : "Not Applicable"}}</div>
                      ...
                      <div ><strong>Changed To :</strong>{{$dataDemo->current ? $dataDemo->current  : "Not Applicable"}}</div> 
                        ...
                        <td>
                        <div>
                       <strong> Action Name :</strong>{{$dataDemo->action_name ? $dataDemo->action_name  : "Not Applicable"}}</div>
                        </td>
                        <td>
