                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 new-date-data-field">
                                            <div class="group-input input-date">
                                                <label for="Date Due">Current Parent Due Date</label>
                                                <div class="calenderauditee">
                                                    <input readonly type="text" id="due_date"  placeholder="DD-MMM-YYYY" value="{{ $data->due_date }}" />
                                                    <input readonly type="text" name="due_date" value="{{ $data->due_date }}" class="hide-input" oninput="handleDateInput(this, 'due_date')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 new-date-data-field">
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    ...
                                                    <input readonly type="text" id="revised_date" 
                                                    ...
                                                    @else
                                                    <input readonly type="text" id="revised_date" 
                                                        placeholder="DD-MMM-YYYY" value="{{ Helpers::getdateFormat($data->revised_date) }}" readonly/>
                                                        <input readonly type="date" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="revised_date" value="{{ $data->revised_date }}" class="hide-input" oninput="handleDateInput(this, 'revised_date')" {{ $data->stage == 0 || $data->stage == 3 ? "disabled" : "" }} />
